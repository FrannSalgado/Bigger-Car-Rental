...
describe('UsersController (e2e)', () => {
    ...
    describe('GET /users/admin-route', () => {
        ...
        beforeAll(async () => {
            ...
            appAdmin.useGlobalPipes(new ValidationPipe({transform: true, whitelist: true}));
            await appAdmin.init();
        });
    ...
    describe('UsersController Admin Access (e2e)', () => {
        ...
        it('should forbid non-admin user from accessing admin-route', async () => {
            ...
            expect(response.body.message).toContain('You don`t have Permission to access this route');
        });
